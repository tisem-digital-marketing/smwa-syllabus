...
2. **Empirical Analysis of Patterns in Social Networks:** which seeks to describes and explain several common patterns found in real-world social networks,
...
& Office Hours:       & TBD \tabularnewline
& Office Hour Format: & In person, 15 min slots \tabularnewline
...
Lab Sections in the subsequent week builds on this material.
...
There are two (2) instances of group work in this class that count towards the assessement, along with formative tasks each week in Lab Sections solved as a group.
...
This mirrors aspects of working "on the job" where teams come from diverse backgrounds and its not always possible to work with friends.
Group work also involves explaining and re-explaining concepts among team members which is a to re-enforce one's own understanding of a concept.
...
Deadlines for signing up will apply, and may be short notice due to scheduling constraints by the TiSEM administration. I
...
This materials should serve to review your existing knowledge from previous classes in your degree program.
The suggested modules can be found on the [here](https://tisem-digital-marketing.github.io/2023-smwa/course_prep/course_prep/)
Instructors will assume you are comfortable with this material by the computing lecture in Week 3.

\textbf{Improving Reproduciblity of our Analysis with Git and GitHub.}
...
Also you can to add us on LinkedIn or Twitter - where we maintain professional accounts.
