...
Beginning in the second week the structure will be as follows: Student Presentations (2 $\times$ 30 mins) and discussion of the preceeding week's Lab Assignment (30 mins).
...
In addition to helping you gain analytics skills using `R`, we want to help you improve the reproducibility of your computational analysis - i.e. weI want you to document your code and the changes you make to it.
