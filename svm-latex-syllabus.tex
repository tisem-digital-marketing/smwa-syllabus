...
\lhead{}
\chead{}
\rhead{\footnotesize $title$ -- $semester$}
\lfoot{}
...
Dates: $if(dates)$$dates$$else$TBD$endif$  &  Class Hours: $if(classhours)$$classhours$$else$TBD$endif$\\
Class Days: $if(days)$$days$$else$TBD$endif$  & Class Room: $if(classroom)$$classroom$$else$TBD$endif$\\
	&  \\
	\hline
	\end{tabular*}
