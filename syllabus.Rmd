...
* Strong interest in understanding how social media and social networks effect brand reputation and the actions of marketers.
* Strong interest in learning and applying about statistical analysis and data science, although with limited existing background (see Pre-reqs below).
* Strong interest in taking quantitative results and developing them into management or marketing insights.
* Interest in learning how to write computer code and acquire the best practice methods.
* Interest in learning new quantiative modelling techniques.
...
$$\textrm{Project Grade} = 0.15 \times \textrm{Proposal} 
                         + 0.10 \times \textrm{Literature Review}
                         + 0.30 \times \left( \textrm{Report + Video} \right)
                        $$
