...
All course materials will be distributed on the \href{https://tisem-digital-marketing.github.io/2022-smwa/}{course website}.
...
Please aim to have everything installed on your own computer by the start of our first lecture.

*We will be available for installation troubleshooting during the first week of the course.*
*You can sign up for to get installation help via our office hour sign-up links.*

\textbf{R \& RStudio.}

You will be required to install `R` and `RStudio` to complete the Labs and group assignments.
Installation instructions are available in the [Installation Guide](https://tisem-digital-marketing.github.io/2022-smwa-installation-guide/) (they differ slightly by operating system):
...
The suggested modules can be found on the [course webpage](https://tisem-digital-marketing.github.io/2022-smwa/) under 'Course Preparation'.
...
* To install Git and create a Github account, follow the instructions in the [Installation Guide](https://tisem-digital-marketing.github.io/2022-smwa-installation-guide/).
...
As part of your preparation for the class, look over the DataCamp modules on "Version Control with Git" that we have highlighted on the [course webpage](https://tisem-digital-marketing.github.io/2022-smwa/) under 'Course Preparation'.
