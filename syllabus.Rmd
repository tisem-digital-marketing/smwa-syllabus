...
The course will involve lectures and discussions, hands on in-class assignments and (when possible) interactions with industry experts. 
The course will strive to balance the practical aspects of social media analytics with a theoretical understanding of the concepts and frameworks involved. 
Each topic covered have a lecture/discussion portion as well as a practicum/exercise/demo portion (called Labs below). 
...
In addition, there are course projects where we will work on the developing our analytical toolkit and framing results around answering marketing questions.
...
This course is an applied course, and as such we aim to use, understand and develop computational routines that help managers make better decisions.
...
Installation instructions are made available [here]().
...
To facilitate the introduction, we have XXX.
...
To achieve this, we will use a version control software called `Git` and we will post our codes on a repository called `GitHub`.

To install Git and create a Github account, follow [these instructions]().
An introductory tutorial in video format is available [here]().
