...
& Office Hours:       & Wednesday, 2pm-3pm, Online or K726 \tabularnewline
& Office Hour Format: & Hybrid, 15 min slots \tabularnewline
& Booking Link:       & https://calendly.com/r-sudhaharan/smwa-office-hours \tabularnewline
\bottomrule
\end{tabular}
\end{table}
...
Each week there will be 2 $\times$ 90 minute lectures.
Lectures will discuss the readings and provide a unified voice/perspective over the course content.
They will mix theory, coding and academic applications of the content under discussion.
Students are encouraged to "code along" live during the code portions of each lecture.
The coding parts of each lecture are "semi-structured", with a starting point, key concepts and an end goal in mind.
...
Furthermore, students are assumed to have read the academic papers in advance of the lecture so that they can participate in the discussions during class.
Lab Sections in the subsequent week build on this material.

\textbf{Lab Sections.}

Weekly Lab Sections (90 minutes) start in the second week.
Each lab section will be split into two parts. 
In the first part of the Lab (45-60 mins), students will discuss a mix of theory based questions or case studies that are detailed in the Lab Assignment.
The second part of the Lab (30-45 mins), students will discuss solutions to the coding exercises of the Lab Assignment.
You are strongly encouraged to prepare before class and bring your questions!
The Lab Section instructor has been advised that the majority of the talking in these classes should be from the students, not the instructor.
